        ...
        <form action="{{ route('peminjamans.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-6 mt-4">
                ...
                <div>
                    ...
                    <input value="{{ $peminjaman->status }}" type="text"
                ...
                <div>
                    ...
                    <a href="{{ asset('storage/peminjamans/' . $peminjaman->surat_pernyataan) }}" target="_blank"
                        class="block w-full px-3 py-2 mt-1 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-blue-500">Lihat Surat Pernyataan</a>
                </div>
            </div>
