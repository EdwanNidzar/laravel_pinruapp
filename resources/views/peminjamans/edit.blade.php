        ...
        <form action="{{ route('peminjamans.update', $peminjaman->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select name="id_ruangan" id="id_ruangan"
                    ...
                    @foreach ($ruangans as $ruangan)
                        <option value="{{ $ruangan->id }}" {{ $peminjaman->id_ruangan == $ruangan->id ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-2 gap-6 mt-4">
                ...
                <div>
                    ...
                    <a href="{{ asset('storage/peminjamans/' . $peminjaman->surat_pernyataan) }}" target="_blank" class="text-blue-600 underline mt-1 block">Lihat Surat Pernyataan</a>
                    @endif
