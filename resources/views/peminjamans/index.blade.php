          ...
          <tbody class="bg-white divide-y">
            @foreach ($peminjaman as $pinjam)
              <tr class="text-gray-700">
                ...
                <td class="px-4 py-3 text-sm">
                  <a href="{{ asset('storage/peminjamans/' . $pinjam->surat_pernyataan) }}" target="_blank"
                  ...
                  <div class="flex space-x-2 items-center">
                    ...
                    <div x-data="{ openDelete: false }" class="inline">
                      ...
                      <button @click="openDelete = true"
                        ...
                        x-show="('{{ auth()->user()->hasRole('peminjam') }}' && '{{ $pinjam->status }}' === 'menunggu')">
                      ...
                      <div x-show="openDelete" x-transition:enter="transition ease-out duration-150"
                        ...
                        <div x-show="openDelete" x-transition:enter="transition ease-out duration-150"
                          ...
                          <footer
                            ...
                            <form action="{{ route('peminjamans.destroy', $pinjam->id) }}" method="POST">
                              @csrf
                              @method('DELETE')
                              <button type="submit"
                    ...
                    <div x-data="{ openVerify: false }" class="inline">
                      ...
                      <button @click="openVerify = true"
                        ...
                        x-show="('{{ auth()->user()->hasRole('operator') }}' || '{{ auth()->user()->hasRole('admin') }}' && '{{ $pinjam->status }}' === 'menunggu')">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                          viewBox="0 0 24 24">
                      ...
                      <div x-show="openVerify" x-transition:enter="transition ease-out duration-150"
                        ...
                        <div x-show="openVerify" x-transition:enter="transition ease-out duration-150"
                          ...
                          <footer
                            ...
                            <form action="{{ route('peminjamans.verify', $pinjam->id) }}" method="POST"
                              class="inline">
                              @csrf
                              @method('PATCH')
                              <button type="submit"
                      ...
                      <div x-show="openReject" x-transition:enter="transition ease-out duration-150"
                        ...
                        <div x-show="openReject" x-transition:enter="transition ease-out duration-150"
                          ...
                          <div class="mt-4 mb-6">
                            ...
                            <form action="{{ route('peminjamans.reject', $pinjam->id) }}" method="POST"
                              class="mt-4">
                              @csrf
                              @method('PATCH')
                              <footer
